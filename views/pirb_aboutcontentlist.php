			...
			<div class="col-md-12">
				<div class="card">
					<div class="header">
						...
						<p class="pirb_aboutcontent"></p><br>
					</div>
					...
					<!-- <a href="<?php //echo base_url();?>admincontrol/newpirb_aboutcontent"><button type="button" class="btn btn-info btn-fill pull-right">Add New</button></a><br><br>	 -->
					<?php } ?>
					...
					<div class="content table-responsive table-full-width">						
						...
						?>
								<tr>
									...
									<td>
										<a href="<?php echo base_url();?>admincontrol/editpirb_aboutcontent/<?php echo $row['id'] ; ?>">Edit</a>
									</td>									
								</tr>
						<?php 
							$i++;
...
<script type="text/javascript">
    	$(document).ready(function(){ 
			$('.active').click(function(){
				...
				var url = '<?php echo base_url().'admincontrol/pirb_aboutcontentlist'; ?>';
			...
			$('.delete').click(function(){				
				if(confirm("Are you sure to delete this record ?")){
					...
					var url = '<?php echo base_url().'admincontrol/deletepirb_aboutcontent'; ?>';
