		...
		<div class="row">
			<div class="col-md-8">
				<div class="card">
					<div class="header">
					<?php if ($action == "new") { ?>
						<h4 class="title">IOPSA Physical Address Manager</h4>
					<?php } if ($action == "edit") { ?>
						<h4 class="title">Update IOPSA Physical Address Manager</h4>
					<?php } ?>
					</div>
					<div class="content">
						<form method="post" action="<?php echo base_url();?>admincontrol/iopsa_addressaction"  enctype="multipart/form-data">
							<div class="row">
								<div class="col-md-12">
						...
						<?php } ?>
							...
							<a href="<?php echo base_url();?>admincontrol/iopsa_addressaction"><button type="button" class="btn btn-warning btn-fill pull-left">Back</button></a>
