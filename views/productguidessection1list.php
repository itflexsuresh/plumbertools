...
<a href="<?php echo base_url();?>admincontrol/productguidesaction"><?php echo $productguidesname['content']; ?></a>
					...
					<div class="back-btn" style="display: inline-block;width: 89%;">
						<a href="<?php echo base_url().'admincontrol/productguideslist'; ?>"><button type="button" class="btn btn-warning btn-fill pull-right">Back</button></a>
					</div>
					<?php if (isset($permission) && ($permission =='1')) { ?>
					<div class="addnew-btn" style="float: right;">				
						<a href="<?php echo base_url();?>admincontrol/newproductguidessection1/<?php echo $productguidesid; ?>"><button id="addnew" type="button" class="btn btn-info btn-fill pull-right">Add New</button></a><br><br>	
					</div>
					<?php } ?>
					</div>
					...
					<div class="content table-responsive table-full-width">						
						...
						?>
								<tr>
									...
									<td><a href="<?php echo base_url();?>admincontrol/editproductguidessection1/<?php echo $productguidesid; ?>/<?php echo $row['id'] ; ?>">Edit</a> 
										<?php if (isset($permission) && ($permission =='1')) { ?> / <a href="#" deleteid="<?php echo $row['id']; ?>" class="delete">Delete</a> 
										<?php } ?>
										<?php if($row['pdf'] =='0'){ ?> / <a href="<?php echo base_url();?>admincontrol/productguidessection2list/<?php echo $productguidesid; ?>/<?php echo $row['id'] ; ?>">Edit Sections</a> <?php } ?></td>
								</tr>
						<?php 
							$i++;
							}
    	...
    	$(document).ready(function(){ 
			...
			$('.delete').click(function(){				
				if(confirm("Are you sure to delete this record ?")){
					...
					var url = '<?php echo base_url().'admincontrol/deleteproductguidessection1/'.$productguidesid; ?>';
