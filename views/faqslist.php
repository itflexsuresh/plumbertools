		...
		<div class="row">
			<div class="col-md-12">
				<div class="card">
					...
					<a href="<?php echo base_url();?>admincontrol/newfaqs"><button type="button" class="btn btn-info btn-fill pull-right">Add New</button></a><br><br>	
					...
					<div class="content table-responsive table-full-width">						
						...
						?>
								<tr>
									...
									<td><a href="<?php echo base_url();?>admincontrol/editfaqs/<?php echo $row['id'] ; ?>">Edit</a> / <a href="#" deleteid="<?php echo $row['id']; ?>" class="delete">Delete</a></td>
								</tr>
						<?php 
							$i++;
							}
...
<script type="text/javascript">
    	$(document).ready(function(){ 
			$('.active').click(function(){
				...
				var url = '<?php echo base_url().'admincontrol/faqslist'; ?>';
			...
			$('.delete').click(function(){				
				if(confirm("Are you sure to delete this record ?")){
					...
					var url = '<?php echo base_url().'admincontrol/deletefaqs'; ?>';
