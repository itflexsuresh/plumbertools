		...
		<div class="row">
			<div class="col-md-8">
				<div class="card">
					<div class="header">
					<?php if ($action == "new") { ?>
						<h4 class="title">New Background Image Manager</h4>
					<?php } if ($action == "edit") { ?>
						<h4 class="title">Update Background Image Manager</h4>
					<?php } ?>
					</div>
					<div class="content">
						<form method="post" action="<?php echo base_url();?>admincontrol/backbanneraction"  enctype="multipart/form-data">
						...
						<?php } ?>
							...
							<a href="<?php echo base_url();?>admincontrol/backbanneraction"><button type="button" class="btn btn-warning btn-fill pull-left">Back</button></a>
