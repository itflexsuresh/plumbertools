		...
		<div class="row">
			<div class="col-md-8">
				<div class="card">
					...
					<?php } if ($action == "edit") { ?>
						<h4 class="title">Update IOPSA Membership Fees</h4>
					<?php } ?>
					</div>
					<div class="content">
						<form method="post" action="<?php echo base_url();?>admincontrol/iopsa_membershipfeesaction"  enctype="multipart/form-data">	
							<div class="row">
								<div class="col-md-6">
						...
						<?php } ?>
							...
							<a href="<?php echo base_url();?>admincontrol/iopsa_membershipfeesaction"><button type="button" class="btn btn-warning btn-fill pull-left">Back</button></a>
