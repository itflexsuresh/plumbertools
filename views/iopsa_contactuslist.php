	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-md-12">
				<div class="card">
					<div class="header">
						<h4 class="title">IOPSA Contact Us</h4>
					...
					<!-- <a href="<?php //echo base_url();?>admincontrol/newiopsa_contactus"><button type="button" class="btn btn-info btn-fill pull-right">Add New</button></a><br><br>	 -->
					<?php } ?>
					...
					<div class="content table-responsive table-full-width">						
						...
						?>
								<tr>
									...
									<?php if (isset($permission) && ($permission =='1')) { ?>								
									<td><a href="<?php echo base_url();?>admincontrol/viewiopsa_contactus/<?php echo $row['id'] ; ?>">View</a></td>
									<?php }else{ ?>
										<td></td>
									<?php } ?>
								</tr>
