			...
			<div class="col-md-12">
				<div class="card">
					...
					<?php if (isset($permission) && ($permission =='1')) { ?>
						<a href="<?php echo base_url();?>admincontrol/addnewtoolboxtalks"><button type="button" class="btn btn-info btn-fill pull-right">Add New</button></a><br><br>	
					<?php } ?>
					...
					<div class="content table-responsive table-full-width">						
						...
						?>
								<tr>
									...
									<td>
										<a href="<?php echo base_url();?>admincontrol/editnewtoolboxtalks/<?php echo $row['id'] ; ?>">Edit</a>
										<?php if (isset($permission) && ($permission =='1')) { ?> / <a href="javascript:void(0)" deleteid="<?php echo $row['id']; ?>" class="delete">Delete</a> <?php } ?>
										  <?php if($row['pdf'] =='0'){ ?>/ <a href="<?php echo base_url();?>admincontrol/newtoolboxtalks1list/<?php echo $row['id'] ; ?>">Edit Sections</a>
										  <?php } ?>
									</td>																	
								</tr>
						<?php 
    	...
    	$(document).ready(function(){ 
			...
			$('.delete').click(function(){				
				if(confirm("Are you sure to delete this record ?")){
					...
					var url = '<?php echo base_url().'admincontrol/deletenewtoolboxtalks'; ?>';
