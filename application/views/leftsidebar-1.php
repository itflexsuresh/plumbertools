...
<head>
	...
	<!-- datepicker 	
	<link href="<?php echo base_url(); ?>assets/css/bootstrap-datepicker.min.css" rel="stylesheet"/> -->		<link href="<?php echo base_url(); ?>assets/css/bootstrap-datepicker.min.css" rel="stylesheet"/>	<link href="<?php echo base_url(); ?>assets/css/jquery.timepicker.min.css" rel="stylesheet"/>		
    ...
    -->
    	...
    	<div class="sidebar-wrapper">
            ...
            <ul class="nav">
				...
				</li>								<li id="treeview2">					<a href="#" class="dropdown-toggle" data-toggle="dropdown">						<i class="pe-7s-helm"></i>						<p>ARTICULATE IT <b class="caret"></b></p>					</a>										<ul id="treeview-menu2">												<li <?php if($leftsidebar_value == 32 ) { ?> class="active" <?php } ?>>							<a href="<?php echo base_url();?>admincontrol/webinarslist">								 								<p> WEBINARS</p>							</a>						</li>						<li <?php if($leftsidebar_value == 33 ) { ?> class="active" <?php } ?>>							<a href="<?php echo base_url();?>admincontrol/radiolist">								 								<p> RADIO</p>							</a>						</li>					</ul>				</li>
				<li <?php if($leftsidebar_value == 34 ) { ?> class="active" <?php } ?> >                    <a href="<?php echo base_url();?>admincontrol/contactlist">                        <i class="pe-7s-mail"></i>                        <p>Contact us</p>                    </a>                </li>
            </ul>
    	</div>
    </div>
