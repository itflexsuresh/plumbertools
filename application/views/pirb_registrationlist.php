	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-md-12">
				<div class="card">
					<div class="header">
						<h4 class="title">PIRB Registration Content</h4>
						<p class="pirb_registration"></p><br>
					</div>
					...
					<!-- <a href="<?php //echo base_url();?>admincontrol/newpirb_registration"><button type="button" class="btn btn-info btn-fill pull-right">Add New</button></a><br><br>	 -->
					<?php } ?>
					...
					<div class="content table-responsive table-full-width">						
						...
						?>
								<tr>
									...
									<td><a href="<?php echo base_url();?>admincontrol/editpirb_registration/<?php echo $row['id'] ; ?>">Edit</a> </td>									
								</tr>
						<?php 
							$i++;
							}
...
<script type="text/javascript">
    	$(document).ready(function(){ 
			$('.active').click(function(){
				...
				var url = '<?php echo base_url().'admincontrol/pirb_registrationlist'; ?>';
			...
			$('.delete').click(function(){				
				if(confirm("Are you sure to delete this record ?")){
					...
					var url = '<?php echo base_url().'admincontrol/deletepirb_registration'; ?>';
