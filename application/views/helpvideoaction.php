		...
		<div class="row">
			<div class="col-md-8">
				<div class="card">
					...
					<div class="content">
						<form method="post" class="form" action="<?php echo base_url();?>admincontrol/helpvideoaction"  enctype="multipart/form-data">
							<div class="row">
								<div class="col-md-12">
							...
							<div class="row">
								<div class="col-md-12">
									...
									<?php if ($action == "new") { ?>
										<input name="position" type="text" id="position" class="form-control" placeholder="Position" value="<?php echo set_value('position'); ?>">
									<?php } if ($action == "edit") { ?>
						...
						<?php } ?>
							...
							<a href="<?php echo base_url();?>admincontrol/helpvideolist"><button type="button" class="btn btn-warning btn-fill pull-left">Back</button></a>
