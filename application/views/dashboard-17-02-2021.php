...
<script type="text/javascript">
    	$(document).ready(function(){ 
			...
			$('#searchclick').click(function(){				
				...
				var url = '<?php echo base_url().'admincontrol/dashboard'; ?>';
				$('<form method="post" action="'+url+'"><input type="hidden" name="daterangevalue" value="'+daterangevalue+'"><input type="hidden" name="fromdate" value="'+fromdate+'"><input type="hidden" name="todate" value="'+todate+'"></form>').appendTo('body').submit();
			});
			...
			$('#searchclick1').click(function(){				
				...
				var url = '<?php echo base_url().'admincontrol/dashboard'; ?>';
				$('<form method="post" action="'+url+'"><input type="hidden" name="daterangevalueA" value="'+daterangevalue+'"><input type="hidden" name="fromdateA" value="'+fromdate+'"><input type="hidden" name="todateA" value="'+todate+'"></form>').appendTo('body').submit();
			});
			...
			$('#download1').click(function(){				
				...
				// var url = '<?php  echo base_url().'assets/uploads/dashboardreport/'; ?>'+filename+''+'.csv'+'';
				$.ajax({					
					data: {fromdate: fromdate, todate: todate, activestatus: activestatus},
			        type: 'POST',
