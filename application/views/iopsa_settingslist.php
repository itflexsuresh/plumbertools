	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-md-12">
				<div class="card">
					<div class="header">
						<h4 class="title">IOPSA Settings</h4>
						<p class="iopsa_settings"></p><br>
					</div>
					...
					<?php if (isset($permission) && ($permission =='1')) { ?>
						<a href="<?php echo base_url();?>admincontrol/newiopsa_settings"><button type="button" class="btn btn-info btn-fill pull-right">Add New</button></a><br><br>	
					<?php } ?>
					...
					<div class="content table-responsive table-full-width">						
						...
						?>
								<tr>
									...
									<?php if (isset($permission) && ($permission =='1')) { ?>
									<td><a href="<?php echo base_url();?>admincontrol/editiopsa_settings/<?php echo $row['id'] ; ?>">Edit</a> / <a href="#" deleteid="<?php echo $row['id']; ?>" class="delete">Delete</a></td>
									<?php }else{ ?>
										<td></td>
									<?php } ?>
								</tr>
...
<script type="text/javascript">
    	$(document).ready(function(){ 
			$('.active').click(function(){
				...
				var url = '<?php echo base_url().'admincontrol/iopsa_settingslist'; ?>';
			...
			$('.delete').click(function(){				
				if(confirm("Are you sure to delete this record ?")){
					...
					var url = '<?php echo base_url().'admincontrol/deleteiopsa_settings'; ?>';
