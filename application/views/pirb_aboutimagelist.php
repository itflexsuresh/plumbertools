			...
			<div class="col-md-12">
				<div class="card">
					...
					<?php if (isset($permission) && ($permission =='1')) { ?>
						<?php if(count($getdata) < 3){ ?>
						<a href="<?php echo base_url();?>admincontrol/newpirb_aboutimage"><button type="button" class="btn btn-info btn-fill pull-right">Add New</button></a><br><br>	
						<?php } ?>
					<?php } ?>
					<div class="content table-responsive table-full-width">						
						...
						?>
								<tr>
									...
									<?php if (isset($permission) && ($permission =='1')) { ?>
									<td><a href="<?php echo base_url();?>admincontrol/editpirb_aboutimage/<?php echo $row['id'] ; ?>">Edit</a> / <a href="#" deleteid="<?php echo $row['id']; ?>" class="delete">Delete</a></td>
									<?php }else{ ?>
										<td></td>
									<?php } ?>
								</tr>
...
<script type="text/javascript">
    	$(document).ready(function(){ 
			$('.active').click(function(){
				...
				var url = '<?php echo base_url().'admincontrol/pirb_aboutimagelist'; ?>';
			...
			$('.delete').click(function(){				
				if(confirm("Are you sure to delete this record ?")){
					...
					var url = '<?php echo base_url().'admincontrol/deletepirb_aboutimage'; ?>';
