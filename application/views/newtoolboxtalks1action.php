		...
		<div class="row">
			<div class="col-md-8">
				<div class="card">
					<div class="header">
					<?php if ($action == "new") { ?>
						<h4 class="title"><?php echo $toolboxname['content']; ?> Content Manager</h4>
					<?php } if ($action == "edit") { ?>
						<h4 class="title"><?php echo $toolboxname['content']; ?> Update Content Manager</h4>
					<?php } ?>
					</div>
					<div class="content">
						<form method="post" action="<?php echo base_url();?>admincontrol/newtoolboxtalks1action/<?php echo $toolboxid; ?>"  enctype="multipart/form-data">							
							<div class="row">
								<div class="col-md-12">
									<div class="form-group">	
										<input name="toolboxid" type="hidden" class="form-control" placeholder="Toolbox Talks" value="<?php echo $toolboxid; ?>">
									</div>
								</div>
							</div>
							<div class="row">
						...
						<?php } ?>
							...
							<a href="<?php echo base_url();?>admincontrol/newtoolboxtalks1list/<?php echo $toolboxid; ?>"><button type="button" class="btn btn-warning btn-fill pull-left">Back</button></a>
