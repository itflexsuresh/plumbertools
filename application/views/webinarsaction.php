		...
		<div class="row">
			<div class="col-md-8">
				<div class="card">
					...
					<div class="content">
						<form method="post" action="<?php echo base_url();?>admincontrol/webinarsaction"  enctype="multipart/form-data">
							<div class="row">
								<div class="col-md-12">
						...
						<?php } ?>
							...
							<a href="<?php echo base_url();?>admincontrol/webinarsaction"><button type="button" class="btn btn-warning btn-fill pull-left">Back</button></a>
