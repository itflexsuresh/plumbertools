		...
		<div class="row">
			<div class="col-md-8">
				<div class="card">
					...
					<?php } if ($action == "edit") { ?>
						<h4 class="title">Update Content</h4>
					<?php } ?>
					</div>
					<div class="content">
						<form method="post" action="<?php echo base_url();?>admincontrol/productrangeaction"  enctype="multipart/form-data">					
							<div class="row">
							...
							<div class="pdfdiv hiddentrue">
								...
								<div class="row">
									<div class="col-md-12">
										...
										<span style='color: red'><?php echo form_error('pdfdescription'); ?></span>
									</div>
								</div>
								<div class="row">
									<div class="col-md-12">
						...
						<div class="btndiv hiddentrue">	
							...
							<a href="<?php echo base_url();?>admincontrol/productrange"><button type="button" class="btn btn-warning btn-fill pull-left">Back</button></a>
