		...
		<div class="row">
			<div class="col-md-8">
				<div class="card">
					<div class="header">
					<?php if ($action == "new") { ?>
						<h4 class="title"><?php echo $productguidesname['content']; ?> - <?php echo $productguidessection1name['content']; ?> -Content</h4>
					<?php } if ($action == "edit") { ?>
						<h4 class="title"><?php echo $productguidesname['content']; ?> - <?php echo $productguidessection1name['content']; ?> -Update Content</h4>
					<?php } ?>
					</div>
					<div class="content">
						<form method="post" action="<?php echo base_url();?>admincontrol/productguidessection2action/<?php echo $productguidesid; ?>/<?php echo $productguidessection1id; ?>"  enctype="multipart/form-data">							
							<div class="row">
								<div class="col-md-12">
						...
						<div class="btndiv hiddentrue">	
							...
							<a href="<?php echo base_url();?>admincontrol/productguidessection2action/<?php echo $productguidesid; ?>/<?php echo $productguidessection1id; ?>"><button type="button" class="btn btn-warning btn-fill pull-left">Back</button></a>
