...
<a href="<?php echo base_url();?>admincontrol/productguidessection2action/<?php echo $productguidesid; ?>/<?php echo $productguidessection1id; ?>"><?php echo $productguidessection2name['content']; ?></a>
					...
					<a href="<?php echo base_url();?>admincontrol/newproductguidessection3/<?php echo $productguidesid; ?>/<?php echo $productguidessection1id; ?>/<?php echo $productguidessection2id; ?>"><button id="addnew" type="button" class="btn btn-info btn-fill pull-right">Add New</button></a>
					<?php } ?><br><br>	
